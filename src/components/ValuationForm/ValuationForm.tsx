  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 sticky top-16 bg-gray-50 z-40 py-4">
            ...
            {steps.map((stepName, index) => (
              <React.Fragment key={stepName}>
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-[10px] sm:text-xs mt-2 text-center text-gray-600 max-w-[60px] sm:max-w-[80px] hidden sm:block">
                    {stepName}
                  </span>
                </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 sm:p-12 min-h-[500px]">
          {renderStep()}
        </div>
      </div>
    </div>
